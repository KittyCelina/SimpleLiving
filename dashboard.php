        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <nav class="navbar navbar-expand-md bg-body shadow-sm mb-4">
                <div class="container-fluid"><a class="navbar-brand d-flex align-items-center" href="dashboard.php">
                        ...
                        </div><span>West Prime Smart Power Automation</span>
            ...
            <div id="content">
                <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span><?= DevicesCount() ?></span>
                                            </div>
                                        </div>
                                        <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                                height="1em" fill="currentColor" viewBox="0 0 16 16"
                                                class="bi bi-boxes text-primary fa-2x">
                                                <path
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span><?= RelaysCount() ?></span>
                                            </div>
                                        </div>
                                        <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                                height="1em" fill="currentColor" viewBox="0 0 16 16"
                                                class="bi bi-bounding-box text-success fa-2x">
                                                <path
                                    ...
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span
                                                    class="text-info">Users</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?= UsersCount() ?></span>
                                            </div>
                                        </div>
                            ...
                            <div class="card shadow border-start-warning py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span
                                                    class="text-info">Date &amp; Time</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span id="time_date">00/00/0000
                                                    00:00</span></div>
                                        </div>
                    ...
                    <div class="container-fluid py-5">
                        <div class="row gy-2 row-cols-1 row-cols-md-2 row-cols-xl-2">
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © West Prime Smart Power Automation
                            2024</span></div>
                </div>
            </footer>
            ...
            switch_on.forEach(turn_on => {
                turn_on.addEventListener('click', function handleClick(event) {
                    ...
                    if (userlevel === 0 || userlevel === level) {
                        ...
                        $.post("functions/generate_relay.php", {
                            relay: relay,
                            type: 'on'
                        }, function (data) {
                        ...
                        // Change class for the on button
                        this.classList.remove('bg-dark');
                        this.classList.add('bg-success');

                        // Change class for the off button (if needed)
                        const offButton = document.querySelector(`.relay-off[data-relay='${relay}']`);
                        if (offButton) {
                            offButton.classList.remove('bg-success');
                            offButton.classList.add('bg-dark');
                        }
                        swal("Success", "Relay " + relay + " is turned on!", "success");

                    } else {
                        swal("Error", "You don't have permission to turn this on", "error");
                    }
                });
            });
            ...
            switch_off.forEach(turn_off => {
                turn_off.addEventListener('click', function handleClick(event) {
                    ...
                    if (userlevel === 0 || userlevel === level) {
                        ...
                        // Change class for the off button
                        this.classList.remove('bg-dark');
                        this.classList.add('bg-success');

                        // Change class for the on button (if needed)
                        const onButton = document.querySelector(`.relay-on[data-relay='${relay}']`);
                        if (onButton) {
                            onButton.classList.remove('bg-success');
                            onButton.classList.add('bg-dark');
                        }

                    } else {
                        swal("Error", "You don't have permission to turn this off", "error");
                    }
                });
            });
